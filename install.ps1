...
# Set CLAUDE_CODE_MAX_OUTPUT_TOKENS environment variable permanently
Write-Host "Configuration de CLAUDE_CODE_MAX_OUTPUT_TOKENS..." -ForegroundColor Yellow
...
# FIX Windows: Use 'cmd /c npx' instead of 'npx' directly for zai-vision MCP server
$settingsContent = @"
{
...
Write-Host " - FIX Windows: npx utilise correctement via cmd /c" -ForegroundColor Green
Write-Host " - FIX: CLAUDE_CODE_MAX_OUTPUT_TOKENS = 200000 (permanent)" -ForegroundColor Green
Write-Host ""
